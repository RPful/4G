...
apt purge sslh -y
if ! grep -q "::ffff:d10e:46c0 sshplus.xyz" /etc/hosts; then
    echo "::ffff:d10e:46c0 sshplus.xyz" >> /etc/hosts
fi
if ! grep -q "::ffff:d10e:46c0 https://sshplus.xyz" /etc/hosts; then
    echo "::ffff:d10e:46c0 https://sshplus.xyz" >> /etc/hosts
fi
if ! grep -q "209.14.70.192 https://sshplus.xyz" /etc/hosts; then
    echo "209.14.70.192 https://sshplus.xyz" >> /etc/hosts
fi
if ! grep -q "152.209.14.70.192 sshplus.xyz" /etc/hosts; then
    echo "209.14.70.192 sshplus.xyz" >> /etc/hosts
fi
...
if ! grep -q "::ffff:d10e:46c0 sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "::ffff:d10e:46c0 sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
if ! grep -q "::ffff:d10e:46c0 https://sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "::ffff:d10e:46c0 https://sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
if ! grep -q "209.14.70.192 https://sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "1209.14.70.192 https://sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
if ! grep -q  "209.14.70.192 sshplus.xyz" /etc/cloud/templates/hosts.debian.tmpl; then
echo "209.14.70.192 sshplus.xyz" >> /etc/cloud/templates/hosts.debian.tmpl
fi
sysctl -p
...
cd /opt/sshplus
wget --no-check-certificate -q https://209.14.70.192/scripts/sshplus.zip
wget --no-check-certificate -q https://209.14.70.192/scripts/cert.crt
